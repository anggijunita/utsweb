                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="{{url('public')}}/aircv/img/jajanan.jpg" alt="Asentus Logo">
                                <img class="logo-img logo-img-active" src="{{url('public')}}/aircv/img/logo.jpg" alt="Asentus Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
